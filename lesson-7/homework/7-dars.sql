use homeworks
 ...
 create database lesson_7_homework
 ...
 (38, 'Juicer', 55.00, 'Electronics', 30), (39, 'Toaster', 40.00, 'Electronics', 70), (40, 'Dishwasher', 500.00, 'Electronics', 20);
...
CREATE TABLE Customers ( CustomerID INT PRIMARY KEY, FirstName VARCHAR(100), LastName VARCHAR(100), Email VARCHAR(100), Phone VARCHAR(50),
...
VALUES (1, 1, 1, '2023-01-01', 150.00), (2, 2, 2, '2023-01-02', 200.00), (3, 3, 3, '2023-01-03', 250.00),
...
select avg(Age) as Ageofemployees from Employees;
...
select count (*)as hr_employers from Employees
...
INSERT INTO Orders VALUES (1, 1, 2, '2023-05-14', 1, 800.00),
